...
const revenueData = {
    ...
    datasets: [
        {
            label: 'Revenue',
            data: [1200, 1900, 3000, 5000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000],
...
<template>
    ...
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card class="p-6">
            <div class="flex items-center justify-between space-y-0">
                ...
                <HandHelping class="h-4 w-4 text-muted-foreground" />
            </div>
            <div class="mt-2">
                <div class="text-2xl font-bold">
        ...
        <CardFooter>
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <div class="text-2xl font-bold">₱{{ formatNumber(50000) }}</div>
                        <p class="text-xs text-muted-foreground">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <div class="text-2xl font-bold">₱{{ formatNumber(20000) }}</div>
                        <p class="text-xs text-muted-foreground">
                            <span class="text-red-500">-5%</span> profit
                        </p>
                    </div>
                </div>
            </div>
    ...
    <Card class="p-6">
        ...
        <CardContent>
            ...
            <img src="https://picsum.photos/200" alt="Tool Image" class="w-full h-20 object-cover mt-4 rounded-md" />
            <div class="mt-4 grid grid-cols-2 gap-4">
                <div>
                    <h5 class="text-sm font-bold mb-3">Tool Details</h5>
                    <p class="text-sm mt-1">Name: {{ topCategoryTool.name }}</p>
                    <p class="text-sm mt-1">Category: {{ topCategoryTool.category }}</p>
                    <p class="text-sm mt-1">Average Rental: ₱{{ formatNumber(topCategoryTool.averageRental) }}</p>
                    <p class="text-sm mt-1">Amount Listed: {{ topCategoryTool.amountListed }}</p>
                    <p class="text-sm mt-1">Average Rating: {{ topCategoryTool.averageRating }} ({{ topCategoryTool.totalReviews }} reviews)</p>
                </div>
                <div>
                    <h5 class="text-sm font-semibold mb-3">Ratings</h5>
                    <div v-for="(count, rating) in topCategoryTool.ratings" :key="rating" class="flex items-center">
            ...
            <div class="mt-7">
                ...
                <div v-for="review in topCategoryTool.reviews" :key="review.user" class="mt-2">
                    ...
                    <p class="text-sm mt-4">{{ review.feedback }}</p>
                    <div class="flex items-center mt-1">
                        <Heart class="h-4 w-4 text-red-500 mt-4" />
                        <p class="text-xs ml-1 mt-4">{{ review.likes }} likes</p>
                    </div>
                </div>
            </div>            
        </CardContent>
